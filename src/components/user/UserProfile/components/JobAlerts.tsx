...
const JobAlerts = () => {
    ...
    return(
        <>
            <div>
                <h1 className="text-xl font-semibold p-4 md:px-0">Job Alerts</h1>
            </div>
            <div className="mt-8 border-2 border-gray-200 p-8 flex items-center space-x-8 shadow-lg">
                ...
                <div className={"w-full md:w-[35%]  items-center space-y-4"}>
                    ...
                    <p className={"text-lg"}>TYou haven't set up any job alerts yet. Create custom alerts to receive notifications for new openings that match your preferences. Set up your first alert<span className={"font-semibold hover:underline cursor-pointer"}>here.</span></p>
